...
namespace Content.Server.Nyanotrasen.Chat
{
    ...
    public sealed class NyanoChatSystem : EntitySystem
    {
        ...
        // Rays: We do not port Nyano's psionic system
        ...
        // Rays: Do not send telepath messages to sleeping people
        ...
        {
            // Rays: We do not port Nyano's psionic system, so we just use the "telepath" component
            return HasComp<TelepathComponent>(entity)
